...
public class ScheduledOperation extends Pollable implements Completable
{
	...
	protected ArrayList<DataItem> dataItemList = null;
	...
	public synchronized void onSuccess(ArrayList<DataItem> d) 
	{
		completed = true;
		success = true;
		dataItemList = d;
	...
	public synchronized ArrayList<DataItem> getDataItemList()
	{
		waitUntilReady();
		return dataItemList;
	}
