 ...
 *
 */
public class ODStreeClient extends AbstractClient
{	
	...
	public ODStreeClient() {}
	public ODStreeClient(SecureRandom r) { rng = r; }
	...
	@Override
	public String getName() { return "ODSTree"; }
