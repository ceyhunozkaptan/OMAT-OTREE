 ...
 *
 */
public class ODStreeCachingClient extends AbstractClient
{	

	private int[] posmap = null;
	
	ODStreeCaching oram = null;
	
	public ODStreeCachingClient() {}
	public ODStreeCachingClient(SecureRandom r) { rng = r; }
	...
	@Override
	public String getName() { return "ODSTree_Caching"; }
