...
//				v.add(sop);
	...
	public ODStree (SecureRandom rand) 
	{
		rnd = rand;
...
//		matFile = new File("./log/" + ss.client + "_" + ss.storage + "_" + clientParams.maxBlocks + "_" + ss.experimentHash + ".perfeval2.txt");
		fw = null;
		try{
		...
		System.out.println("==============================================================================");
		System.out.println("ALL SEARCH & DOWNLOAD TOOK " + (end - start) / 1000000.0 + " ms");
		System.out.println((downTime + decTime) / 1000000.0);
		System.out.println("==============================================================================");
		System.out.println("");
		...
		{ 
//			oldLabels = new int [retrieved.length];
...
//		}
		...
		try {
			...
			bw.write((int) (multiplier*(upTime) / 1000000.0)+",");
			bw.write((int) ((downTime+decTime+multiplier*encTime+multiplier*upTime) / 1000000.0)+",");
			
			bw.newLine();
			bw.flush();
			bw.close();
			bw2.write((int) ((multiplier*upTime+multiplier*encTime+downTime+decTime) / 1000000.0)+"," );
			bw2.flush();
			bw2.close();
		} catch (Exception e) { Errors.error(e); }
		System.out.println("==============================================================================");
		System.out.println("ALL RE-ENCRYPTION & EVICTION TOOK " + (end2 - start2) / 1000000.0 + " ms"); 
		System.out.println((upTime + encTime) / 1000000.0);
		System.out.println("==============================================================================");
		System.out.println("");
